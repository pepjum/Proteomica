...
pdf(file = paste0(projectDir, "results_Venn_PeptidesOfMissingNXProteinsPerSearchEngine.pdf"), width = 10, height = 10)
...
pdf(file="results_Venn_MissingNXProteins_Per_SearchEngine_one_hit_wonders.pdf", width = 10, height = 10)
...
#write.table(results_NX_2, file = paste0(projectDir, "Results/results_NX_summaryby.txt"), col.names=TRUE, row.names = FALSE, sep="\t", quote=FALSE)
